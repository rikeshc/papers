...
to = find(400.300 == round(time, 3), 1);
fromp = find(400.000 == round(timep, 3), 1);
top = find(400.300 == round(timep, 3), 1);
...
f3 = figure(3);
from = find(400.000 ==round(time, 3), 1);
to = find(400.200 ==round(time, 3), 1);
fromp = find(400.000 ==round(timep, 3), 1);
top = find(400.200 ==round(timep, 3), 1);
...
set(f1,'Units','Inches'); %% Vreg and Vrec
pos = get(f1,'Position');
