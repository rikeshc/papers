...
C\textsubscript{load} min. & > 0.6 uF  \\ \hline
...
\begin{table}[htbp]
\caption{Reference and biasing circuit parameters}
\begin{center}
\begin{tabular}{c|c}
\hline \hline
V\textsubscript{ref} & 1.2 V \\ \hline
I\textsubscript{bias} & 10 uA \\ \hline
\hline \hline
\end{tabular}
\end{center}
\label{default}
...
Preliminary report concludes here. \\
