...
\begin{figure}[htbp] %figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=1.05\textwidth]{img/ldo_testbench.pdf} 
...
\begin{figure}[htbp] %figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=1.05\textwidth]{img/ldo_transient_both.pdf} 
...
\begin{figure}[htbp] %figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=1.05\textwidth]{img/ldo_dc_both.pdf} 
...
\begin{figure}[htbp] %figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=1.05\textwidth]{img/ldo_Iload_both.pdf} 
...
Vrec from rectifier is input to the LDO and minimum input to LDO is not reached unless active rectification starts.\\
...
The total power consumed from the source are 30.2 mW and 28.4 mW for pre and post layout simulation for delivering 17.8 mW to 
...
the amplitude of $V_{ac}$ is required to rise to 1.85 \si{\volt}. It is seen that $V_{ac}$ slightly lags in phase with $V_{in}$ due to shift 
...
flattened at the peaks because of voltage drop in coil and pad resistance while the diodes are conducting.[ANYTHING MORE]\\
...
gradually increased to 1.85 V ampltiude to get nominal amplitude of differential inputs to the rectifier. Also seen in 
the plot, current is slightly leading voltage, which means it slightly capacititive and resooance frequency has slight shift.
...
are 56.7\% and 57.8\% respectively for pre and post layout results. As already discussed this difference can be explained with resisitive loss
 in PMS system and load mismatch in resonant inducitve link.\\
...
\hline \hline
					& \textbf{Schematic}	& \textbf{Post-layout} 	\\
\hline \hline
$V_{ac}$			& 1.85 \si{\volt}		& 1.85 \si{\volt} \\ \hline
...
created from 10 mm coil separation. For doing this, respective lumped model of inductive link is used in top testbench, 
...
$V_{ac}$			& 1.58 \si{\volt}		& 1.85 \si{\volt} 		& 2.81 \si{\volt}	\\ \hline
...
\begin{figure} [!htbp]
  \begin{minipage}{\linewidth}
  \centering 
  \subfloat[Primary antenna]  {\includegraphics[width=.48\textwidth]{img/pcb/test_pri.JPG} \label{fig:pcb_pri}}
  \hfill
 \subfloat[Secondary antenna]  {\includegraphics[width=.48\textwidth]{img/pcb/test_sec.JPG}\label{fig:pcb_sec}}
 \hfill
 \end{minipage}\par\medskip
 \centering
 \subfloat[Test PCB board]  {\includegraphics[width=0.8\textwidth]{img/pcb/test_pcb.JPG}\label{fig:pcb_board}}
 \caption{Antenna and test PCBs} 
\label{fig:pcb_all} 
\end{figure}
...
In order to measure input power, $P_{in}$, from source, first a 5 $\Omega $ was connected in series between supply and balun and voltage drop across this 
 ...
 Using matlab, the average input power was calculated by integrating the product of instanteneous current waveform and input voltage waveform, $V_{in}$  in figure \ref{fig:meas_rect_10ma} and dividing 
...
Similarly, ouput power, $P_{load}$ deliverd to load, realised with potentiomfeter, was calculated as product of rms value of $V_{rec}$ 
...
coupling separation is presented here. 3.7 V magnitude sinusoidal  signal is required to drive primary antenna in order to generate 2.65 V differential signals in the secondary coil.\\
...
\begin{sidewaysfigure} [!htbp]	% Layout WPT
 	\centering
  	\includegraphics[width=0.6\textwidth]{appendix/layout_chip_l.pdf} 
...
\begin{figure} [!htbp]	% primary antenna
 	\centering
...
\begin{sidewaysfigure} [!htbp]	% PCB board
 	\centering
