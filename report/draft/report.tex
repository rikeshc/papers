...
Similarly, output power, $P_{load}$ deliverd to load, realised with potentiometer, was calculated as product of rms value of $V_{rec}$ 
...
\hline \hline
				& \textbf{Sepr: 1.5 mm}	& \textbf{Sepr: 5 mm} 	& \textbf{Sepr:10 mm} \\ \hline \hline
$V_{ac}$			& - \si{\volt}			& 3.8 \si{\volt} 			& - \si{\volt}	\\ \hline
$I_{peak}$		& - \si{\milli\ampere}		& - \si{\milli\ampere} 		& 39.2 \si{\milli\ampere} \\ \hline
$P_{in}$			& - \si{\milli\watt}		& 45.6 \si{\milli\watt} 		& - \si{\milli\watt} \\ \hline
$\eta_{wpt}$		& - \%				& 46.1 \%				& - \% \\ 
