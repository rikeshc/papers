...
\item During verification  of the chip, larger ripples, both in $V_{rec}$ and $V_{reg}$ were measured. The main reason for this is rectifier and LDO sharing the same ground path. 
